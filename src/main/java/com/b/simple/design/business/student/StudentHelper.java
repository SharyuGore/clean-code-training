...
public class StudentHelper {
	...
	private static final String DEFAULT_GRADE = "C";
	private static final int EXTRA_CONSTANT = 5;
	private static final int GRADE_B_LIMIT = 50;
	private static final int GRADE_A_LIMIT = 90;
	private static final int EXTRA_LIMIT = 10;
	private static final int GRADEB_UPPERLIMIT = 80;
	private static final int GRADEB_LOWERLIMIT = 51;
	...
	public boolean isGradeB(int marks, boolean isMaths) {
		...
		int gradebLimit =  GRADEB_UPPERLIMIT + extraLimit;
		return marks >= GRADEB_LOWERLIMIT && marks <= gradebLimit;
	}
	...
	public String getGrade(int mark, boolean isMaths) {
		...
		int mathsExtraLimit = isMaths ? 5:0;
		if (mark >= GRADE_A_LIMIT + mathsExtraLimit)
			return "A";
		if (mark >= GRADE_B_LIMIT + mathsExtraLimit) {
			return "B";
		}
		return "C";
	}
